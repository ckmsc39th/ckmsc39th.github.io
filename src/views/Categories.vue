  ...
  <div class="categories-page">
    ...
    <div class="flex justify-start space-x-4">
      <div
        ...
        @click="activeTab = tab"
        :class="[
          'py-2 px-4 font-bold text-gray-500 hover:text-blue-500 ',
    ...
    <div class="px-18 py-4">
      ...
      <div v-if="activeTab === '化學'">
        ...
        <p>楊傑超 ｜ 超哥</p>
        # 226班的班導兼數資班化學老師
        楊傑超老師是226班的導師，也是一位化學老師，老師上課時的投影片總是讓人
        覺得「振奮人心」，翻頁以及字幕的音效讓我們彷彿來到了烏俄戰爭的最前線
        ，耳邊圍繞的雷射激光和爆炸音效使我們不敢在課堂中閉上眼睛，每次化學課
        都精神超好
        # 爬山魔人
        傑超老師超級愛爬山，每次看到他的FB貼文幾乎都是一群老師去爬山，而且老
        師也是時間規劃大師，就連畢旅陪我們玩了四天以後還是可以再去台東花蓮爬
        山，只能說體力真的超好！
        # 還是很年輕
        千萬不要覺得傑超老師已經邁入中年了，其實老師的內心還是非常的年輕，例
        如在義大的時候就是超哥揪團去玩天旋地轉的，而且坐完之後還一派輕鬆，我
        都開始覺得老師比我年輕了，反正我是絕對不敢去做那種對心臟不好的遊樂設
        施啦
        # 專題乾爹
        超哥去年十二月接連拜訪各實驗室教授，分別和化專同學造訪中研院、台大、
        師大，因專題時間為下午，因此大方的超哥不但親自載同學去中研院，還慷慨
        解囊請同學午餐，甚至每週都有其他專題組別同學前來蹭飯，總共於南港車站
        鐵板燒、台大學餐咖哩飯、公館牛排，三處嚴重破費，甚至於群組拜託同學尋
        找「高cp值餐廳」，大家不要再蹭老師的免費午餐了好嗎
        # 開快車
        傑超老師的順風車不是一般人能搭的，心臟不大顆絕對不能上車。經過幾個彎
        道後，你會覺得自己身處秋名山上，正坐在藤原拓海的車上一路狂飆，管你是
        路口轉彎還是上匝道，都沒在跟你開玩笑，一腳油門方向盤打到底，早餐都要
        被甩出來了
        # 零距離
        超哥與學生感情十分要好，不但經常有大學長回來拜訪與經驗分享，平時更會
        與同學談天說地，別科競賽 、同學聚會去哪、爬過哪座山等等，超哥的話題包
        羅萬象，什麼都可以跟你聊上幾句，很親民欸超哥

        # 札實的專題課
        有別於其他科目的專題札記使用頻率時高時低，化學組的研究札記可是要週週
        寫週週交，甚至有組別早已寫滿換第二本，也有同學一次補齊一學期的十幾篇
        札記，可見札記在化專同學的心目中是一本難以忘懷的記憶
        # 生命導師

        當你被超哥約談或者專題課留在學校被超哥拜訪，代表你即將接受一段激勵人
        心的話語洗禮，超哥會鼓勵我們參與各種科展競賽，競賽落榜會獲得溫馨安慰
        考試分數太爛也會獲得特別關心，當被超哥叫到名字時是五味雜陳，是既期待
        又怕受傷害，特別是免修結果要公布的時候。總之，當超哥看好你的時候，你
        最好用功一點
      </div>
      ...
      <div v-if="activeTab === '地科'">
        <p>指導教師：李文禮</p>
        #我聽你唬爛
        高一上地球科學時，文禮老師常常會問先同學如何解釋一個現象，聽完同學解釋後，再說「我聽你唬爛!」，接著開始上課。上完課還會臭屁一下的表示:「老師還是比較厲害吧!」
        #喜歡嘗試各種活動、新科技
        文禮常常找各種科學活動問同學要不要參加，又或是最近流行甚麼ChatGPT，文禮都會找學生討論。
        #你是我的花朵
