    ...
    <div class="px-18 py-4">
      ...
      <div v-if="activeTab === '資訊'">
        ...
        <div class="div-page">
          <h2>指導教師：王鼎中老師</h2>
          <h4>#影分身</h4>
          <p>我們的指導老師是在學校身兼多職的王鼎中老師，他同時兼任了學務處的主任、數個班級的資訊老師，以及我們兩班的專題指導老師還是校內知名社團機器人研究校隊暨社團的指導老師。由於他接了太多個工作，導致他可能出現的地方比其他老師多很多，去哪裡都有可能遇到他，感覺跟影分身沒兩樣。不過這也是一個雙面刃，由於有太多的可能性，許多學生常常有需要找到老師卻找不到的困擾，似乎也有其他老師遇到找不到鼎中老師的困境（？。幸好重要的時候鼎中老師還是會在千鈞一髮之際出現給予最恰到好處的提點，讓同學的專題內容更加完整。</p>
          <h4>#認真用心</h4>
