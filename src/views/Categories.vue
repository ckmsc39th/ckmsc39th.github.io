<script setup>
  import { ref } from 'vue'
  const tabs = ref(['Math', 'Physics', 'Chemistry', 'Biology', 'Informatics', 'Earth Sciences'])
...
<template>
  ...
  <div class="flex justify-start space-x-4">
    <div
      ...
      @click="activeTab = tab"
      :class="[
        'py-2 px-4 rounded-lg font-medium text-gray-500 hover:text-blue-500',
  ...
  <div class="py-4">
    ...
    <div v-if="activeTab === 'Chemistry'">
      <p>指導教師：楊傑超</p>
      <p>[TODO]: 之後去跟化學組要介紹</p>
    </div>
    <div v-if="activeTab === 'Biology'">
      <p>指導教師：朱芳琳</p>
      關於 生物科 朱芳琳老師 的十大事跡 
      <ol>
      ...
      #凌晨通知
      在芳琳老師的世界中，沒有沒有來不及發的通知，只有來不及在上課前發的通知。曾經有好幾次上課前一天晚上的12.以後老師才在GC提醒同學們預習隔天要小考。
      什麼？你問有人10.睡覺怎麼辦？問就是放棄。
      #手繪王者
      身為樹枝班的生物老師， 在教學時難免會需要透過繪製圖片來表達一些艱深的生物概念，此時芳琳老師高超的手繪技巧便派上用場。在老師的鼓（ㄒㄧㄝˊ）勵（ㄆㄛˋ）下，班上同學都不由自主的對這些儼然為世界頂尖藝術品的美及深刻的寓意由衷的發出讚嘆。
      <!-- [TODO]: convert parentheses to ruby text -->
      #手打開開
    ...
    <div v-if="activeTab === 'Informatics'">
      <p>指導教師：王鼎中</p>
    </div>
    <div v-if="activeTab === 'Earth Sciences'">
      <p>指導教師：李文禮</p>
    </div>
  </div>
</template>
